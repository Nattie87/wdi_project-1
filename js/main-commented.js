...
function guess(){
  ...
  if (randomWordArray.indexOf(guess) >= 0) {
    ...
    totalGuesses++;// set up another function that shows the user how many guesses they have left. 10 guesses. 

    numberOfGuesses(totalGuesses);

    alert("Wrong sucker. You've made " + totalGuesses + " guesses");
  };
}

function numberOfGuesses(guesses) {
  if (guesses === 1) {
    $('#image').css("background", "url('./images/kanyeNew.png')")
  } else if (guesses === 2) {
    $('#image').css("background", "url('./images/kanyeNew2.png')")
  } else if (guesses === 3) {
    $('#image').css("background", "url('./images/kanyeNew3.png')")
  } else if (guesses === 4) {
    $('#image').css("background", "url('./images/kanyeNew4.png')")
  } else if (guesses === 5) {
    $('#image').css("background", "url('./images/kanyeNew5.png')")
  } else if (guesses === 6) {
    $('#image').css("background", "url('./images/kanyeNew6.jpg')")
  } else {
